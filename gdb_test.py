...
try:
    ...
    proc = subprocess.Popen('arm-none-eabi-gdb -x gdb_cmd', shell=False, stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE)


    #stdout = proc.communicate()[0]
    #print(stdout)
    gdb_proc_result = proc.stdout.readlines()
